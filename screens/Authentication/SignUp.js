      ...
      createUserWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
          ...
          const userData = {
            displayName: name,
            email: email,
            createdOn: serverTimestamp(), // Add the server timestamp for creation time
            lastLoggedIn: null,
          };
          set(userRef, userData)
            .then(() => {
              console.log("User data added to the Realtime Database");
            })
            .catch((error) => {
              console.log("Error adding user data to the Realtime Database:", error);
            });
